<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\PHPTutorial\WWW\F4\public/../application/manage\view\pay_modl\edit.html";i:1560914793;s:71:"D:\phpStudy\PHPTutorial\WWW\F4\application\manage\view\common\head.html";i:1560913706;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input class="layui-input" name="name" placeholder="通道名称" lay-verify="name" value="<?php echo $data['name']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">通道编号</label>
                <div class="layui-input-block">
                    <input class="layui-input" name="pay_type" placeholder="通道编号" value="<?php echo $data['pay_type']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">基础费率</label>
                <div class="layui-input-block">
                    <input class="layui-input" name="rate" placeholder="基础费率" value="<?php echo $data['rate']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">最小打款金额</label>
                <div class="layui-input-block">
                    <input class="layui-input" name="mini" value="0.01" placeholder="最小打款金额" value="<?php echo $data['mini']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">最大打款金额</label>
                <div class="layui-input-block">
                    <input class="layui-input" name="max" value="49999" placeholder="最大打款金额" value="<?php echo $data['max']; ?>">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
